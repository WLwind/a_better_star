...
#include <a_better_star/gradient_path.h>
#include <a_better_star/quadratic_calculator.h>

PLUGINLIB_EXPORT_CLASS(a_better_star::GlobalPlanner, nav_core::BaseGlobalPlanner)
...
GlobalPlanner::GlobalPlanner() :
        costmap_(NULL), initialized_(false), allow_unknown_(false) {
}

GlobalPlanner::GlobalPlanner(std::string name, costmap_2d::Costmap2D* costmap, std::string frame_id) :
        costmap_(NULL), initialized_(false), allow_unknown_(false) {
//    initialize(name, costmap, frame_id);
    ROS_INFO("Constructing a_better_star plugin!");
}
...
void GlobalPlanner::initialize(std::string name, costmap_2d::Costmap2D* costmap, std::string frame_id) {
    if (!initialized_) {
        ...
        planner_ = new AStarExpansion(p_calc_, cx, cy);//a better star
        ...
        dsrv_ = new dynamic_reconfigure::Server<GlobalPlannerConfig>(ros::NodeHandle("~/" + name));
        dynamic_reconfigure::Server<GlobalPlannerConfig>::CallbackType cb = boost::bind(
...
void GlobalPlanner::reconfigureCB(GlobalPlannerConfig& config, uint32_t level) {
